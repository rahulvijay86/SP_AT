...
public class SPU_289_TC_016_Verify_Tools_In_HomePage extends Prerequsite {

    @Parameters({"platform","browserName","remoteurl","url"})
    @BeforeClass
    public void browserInitialization(String platform,String browserName,String remoteurl,String url) throws Exception {

        ResultUtil.createReport("SPU_289_TC_016_Verify_Tools_In_HomePage",browserName,platform,url);
        driver=launchURL(platform, browserName, remoteurl, url);
    }

    @Test
    public void SPU_289_TC_016_Verify_Tools_In_HomePage() {
        try {
            ...
            ResultUtil.report("FAIL", "Execution failed", "User not able to compare the tools and resources added to favorites", "" + e.getMessage(), driver);
            driver.quit();
        }
    }
