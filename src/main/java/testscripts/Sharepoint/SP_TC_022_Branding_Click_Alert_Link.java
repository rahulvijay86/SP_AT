...
public class SP_TC_022_Branding_Click_Alert_Link extends Prerequsite {

    @Parameters({"platform","browserName","remoteurl","url"})
    @BeforeClass
    public void browserInitialization(String platform,String browserName,String remoteurl,String url) throws Exception {

        ResultUtil.createReport("SP_TC_022_Branding_Click_Alert_Link",browserName,platform,url);
        driver=launchURL(platform, browserName, remoteurl, url);
    }

    @Test
    public void SP_TC_022_03_Search_Branding_Click_Alert_Link() {
        try {
            ...
            //To verify Email Menu
            _ref.blogPage.verifyEmailMenu(driver);
            _ref.sharePointHomePage.clickSignOutDropdownMenu(driver,BrowserName);
