...
public class SP_TC_004_SearchResult_Verify_Alert_Link extends Prerequsite {

    @Parameters({"platform","browserName","remoteurl","url"})
    @BeforeClass
    public void browserInitialization(String platform,String browserName,String remoteurl,String url) throws Exception {

        ResultUtil.createReport("SP_TC_004_SearchResult_Verify_Alert_Link",browserName,platform,url);
        driver=launchURL(platform, browserName, remoteurl, url);
    }

    @Test
    public void SP_TC_004_SearchResult_Verify_Alert_Link() {
        try {
            ...
            // To click ok menu in the alert page
