 ...
 */
public class SP_TC_013_UsernamePage_Verify_NewsFeed_Settings extends Prerequsite {

    @Parameters({"platform","browserName","remoteurl","url"})
    @BeforeClass
    public void browserInitialization(String platform,String browserName,String remoteurl,String url) throws Exception {

        ResultUtil.createReport("SP_TC_013_UsernamePage_Verify_NewsFeed_Settings",browserName,platform,url);
        driver=launchURL(platform, browserName, remoteurl, url);
    }

    @Test
    public void SP_TC_013_UsernamePage_Verify_NewsFeed_Settings() {
        try {
            ...
            _ref.userPage.checkOrUnCheckPeopleIFollow(driver,BrowserName);
