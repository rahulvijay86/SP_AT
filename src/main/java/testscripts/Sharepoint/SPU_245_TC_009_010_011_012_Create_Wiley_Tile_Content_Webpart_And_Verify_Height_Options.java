...
public class SPU_245_TC_009_010_011_012_Create_Wiley_Tile_Content_Webpart_And_Verify_Height_Options extends Prerequsite {
    ...
    public void browserInitialization(String platform,String browserName,String remoteurl,String webparturl) throws Exception {
        ...
        ResultUtil.createReport("SPU_245_TC_009_010_011_012_Create_Wiley_Tile_Content_Webpart_And_Verify_Height_Options",browserName,platform,webparturl);
        driver=launchURL(platform, browserName, remoteurl, webparturl);
    }

    @Test
    public void SPU_245_TC_009_010_011_012_Create_Wiley_Tile_Content_Webpart_And_Verify_Height_Options() {
        try {
            ...
            _ref.createPage.clickMenuInWileyParts(driver,BrowserName,"Wiley Tile Content Block");
