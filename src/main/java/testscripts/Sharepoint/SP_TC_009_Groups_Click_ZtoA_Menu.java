...
public class SP_TC_009_Groups_Click_ZtoA_Menu extends Prerequsite {

    @Parameters({"platform","browserName","remoteurl","url"})
    @BeforeClass
    public void browserInitialization(String platform,String browserName,String remoteurl,String url) throws Exception {

        ResultUtil.createReport("SP_TC_009_Groups_Click_ZtoA_Menu",browserName,platform,url);
        driver=launchURL(platform, browserName, remoteurl, url);
    }

    @Test
    public void SP_TC_009_Groups_Click_ZtoA_Menu() {
        try {
            ...
            _ref.groupsPage.clickZtoAMenuInGroupsPage(driver,BrowserName);
