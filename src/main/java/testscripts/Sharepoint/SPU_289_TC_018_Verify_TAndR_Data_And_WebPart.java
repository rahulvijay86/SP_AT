...
public class SPU_289_TC_018_Verify_TAndR_Data_And_WebPart extends Prerequsite {

    @Parameters({"platform","browserName","remoteurl","url"})
    @BeforeClass
    public void browserInitialization(String platform,String browserName,String remoteurl,String url) throws Exception {

        ResultUtil.createReport("SPU_289_TC_018_Verify_TAndR_Data_And_WebPart",browserName,platform,url);
        driver=launchURL(platform, browserName, remoteurl, url);
    }

    @Test
    public void SPU_289_TC_018_Verify_TAndR_Data_And_WebPart() {
        try {
            ...
            // To verify WebPart
            _ref.toolsAndResourcesPage.verifyWebPart(driver);
            // To click tools menu option
            _ref.sharePointHomePage.clickToolsMenuOption(driver,BrowserName);
            ...
            ResultUtil.report("FAIL", "Execution failed", "User not able to compare the tools and resources data and WebPart", "" + e.getMessage(), driver);
            driver.quit();
        }
    }
