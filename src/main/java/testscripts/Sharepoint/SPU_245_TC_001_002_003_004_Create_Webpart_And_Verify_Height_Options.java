...
public class SPU_245_TC_001_002_003_004_Create_Webpart_And_Verify_Height_Options extends Prerequsite {
    ...
    public void browserInitialization(String platform,String browserName,String remoteurl,String webparturl) throws Exception {
        ...
        ResultUtil.createReport("SPU_245_TC_001_002_003_004_Create_Webpart_And_Verify_Height_Options",browserName,platform,webparturl);
        driver=launchURL(platform, browserName, remoteurl, webparturl);
    }

    @Test
    public void SPU_245_TC_001_002_003_004_Create_Webpart_And_Verify_Height_Options() {
        try {
            ...
            _ref.createPage.clickMenuInWileyParts(driver,BrowserName,"Wiley Image Content Block");
            // To click Add menu
...
//            _ref.createPage.clickAppearanceOption();
            ...
            ResultUtil.report("FAIL", "Execution failed", "User not able to click Add Webpart menu and verify height options", "" + e.getMessage(), driver);
            driver.quit();
        }
    }
