...
public class ResultUtil extends ExtendedLibrary{
	public static Map<String,String> reportFilesMap = new LinkedHashMap<String, String>();
	public static Map<String,Integer> stepcountMap = new LinkedHashMap<String, Integer>();
	public static Map<String,String> currentReportIdMap = new LinkedHashMap<String, String>();
...
//	private static int inTestCountfor1=0;
//	private static int inTestCountfor2=0;
//	private static int inStepCountfor1=0;
//	private static int inStepCountfor2=0;
...
//			XMLUtil.addNodeWithText(strResultFolder+"/"+strReportFile, "//table[@id='tblDetail']/tbody/tr[@id='"+strID+"']", "td",strDesc);
			...
			if(strStatus.equalsIgnoreCase("PASS")){
	           blResult=true;
	        	...
	        	blResult=false;
				String currentReportId = currentReportIdMap.get(strThreadID);
	            XMLUtil.addNodeText(strResultFolder+"/Summary.html", "//table[@id='tblSummary']/tbody/tr[@id='"+currentReportId+"']/td[6]","FAIL");
	            XMLUtil.addAttribute(strResultFolder+"/Summary.html", "//table[@id='tblSummary']/tbody/tr[@id='"+currentReportId+"']","name","FAIL");
	            
	            /******Change FONT COLOR********/
	            
	            XMLUtil.addAttribute(strResultFolder+"/Summary.html", "//table[@id='tblSummary']/tbody/tr[@id='"+currentReportId+"']/td[1]","style","color:red;font-weight:bold;");
	            XMLUtil.addAttribute(strResultFolder+"/"+strReportFile, "//table[@id='tblDetail']/tbody/tr[@id='"+strID+"']/td[1]", "style","color:red;font-weight:bold;");
	            
	            XMLUtil.addAttribute(strResultFolder+"/Summary.html", "//table[@id='tblSummary']/tbody/tr[@id='"+currentReportId+"']/td[2]","style","color:red;font-weight:bold;");
	            XMLUtil.addAttribute(strResultFolder+"/"+strReportFile, "//table[@id='tblDetail']/tbody/tr[@id='"+strID+"']/td[2]", "style","color:red;font-weight:bold;");
	            
	            XMLUtil.addAttribute(strResultFolder+"/Summary.html", "//table[@id='tblSummary']/tbody/tr[@id='"+currentReportId+"']/td[3]","style","color:red;font-weight:bold;");
	            XMLUtil.addAttribute(strResultFolder+"/"+strReportFile, "//table[@id='tblDetail']/tbody/tr[@id='"+strID+"']/td[3]", "style","color:red;font-weight:bold;");
	            
	            XMLUtil.addAttribute(strResultFolder+"/Summary.html", "//table[@id='tblSummary']/tbody/tr[@id='"+currentReportId+"']/td[4]","style","color:red;font-weight:bold;");
	            XMLUtil.addAttribute(strResultFolder+"/"+strReportFile, "//table[@id='tblDetail']/tbody/tr[@id='"+strID+"']/td[4]", "style","color:red;font-weight:bold;");
	            
	            XMLUtil.addAttribute(strResultFolder+"/Summary.html", "//table[@id='tblSummary']/tbody/tr[@id='"+currentReportId+"']/td[5]","style","color:red;font-weight:bold;");
	            XMLUtil.addAttribute(strResultFolder+"/"+strReportFile, "//table[@id='tblDetail']/tbody/tr[@id='"+strID+"']/td[5]", "style","color:red;font-weight:bold;");
	            
	            XMLUtil.addAttribute(strResultFolder+"/Summary.html", "//table[@id='tblSummary']/tbody/tr[@id='"+currentReportId+"']/td[6]","style","color:red;font-weight:bold;");
	            XMLUtil.addAttribute(strResultFolder+"/"+strReportFile, "//table[@id='tblDetail']/tbody/tr[@id='"+strID+"']/td[6]", "style","color:red;font-weight:bold;");
...
/*	@SuppressWarnings("unused")
	...
	public synchronized static void createReport(String strScriptName, String strBrowser,String strMachine, String url) throws Exception{

		String strThreadID=""+Thread.currentThread().getId();
		String strReportFileName=strScriptName+"-"+DateUtil.getCurrentDate("yyyy_MM_dd_HH_mm_sss") + "_" + strThreadID;
		...
		stepcountMap.put(strThreadID, 0);
...
//		String strBrowser = dataMap.get("Browser");
		...
		try{
			...
			Map<String,String> attributeMap=new HashMap<String, String>();
			strCurrentReportID=DateUtil.getCurrentDate("yyyy_MM_dd_HH_mm_sss")+strThreadID;
			currentReportIdMap.put(strThreadID, strCurrentReportID);
   ...
   private synchronized static int getCount(){
	...
	private synchronized static int getStepCount(){
		String strThreadID=""+Thread.currentThread().getId();
		int count = stepcountMap.get(strThreadID);
		count++;
		stepcountMap.put(strThreadID, count);
		return count;
	}
